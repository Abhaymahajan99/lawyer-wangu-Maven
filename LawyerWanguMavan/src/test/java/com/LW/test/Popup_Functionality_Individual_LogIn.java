...
public class Popup_Functionality_Individual_LogIn  {
	...
	/*
	 * @Test(dataProvider="UserData") public void Popup_Individual_LogIn(String
	 * UserName , String UserPasword) throws InterruptedException, IOException {
	 * 
	 ...
	 * 
	 * //Sign in popup
	 * driver.findElement(By.xpath("//input[@id=\"login_username\"]")).sendKeys(
	 * UserName);
	 * driver.findElement(By.xpath("//input[@id=\"login_password\"]")).sendKeys(
	 * UserPasword);
	 ...
	 * 
	 * { String empdata [][]= {{ "1231346546" , "tester@123"},{"123134654" ,
	 * "tester@123"},{"testerlw1","tester@123"}}; return empdata; }
	 * 
  ...
  "dadadawd465"}, { "1231645546" , "tester@gmail.com" , "tester@123" ,
  "tester@123" , "45656456465" }, {"AutomatdTestUser1" ,
